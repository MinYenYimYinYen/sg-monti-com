...
export function CustomSubProductInput({
  subProductIndex,
  ...
  const handleAmountChange = (value: number | null) => {
    const updatedSubProducts = loadout.subProducts.map((s, idx) => {
      if (idx === subProductIndex) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={() => removeProductFromLoadout(subProduct.product.productId)}
