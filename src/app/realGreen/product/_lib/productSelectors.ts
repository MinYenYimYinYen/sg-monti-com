...
const selectProductCategories = (state: AppState) =>
  state.productCategory.productCategories;

const selectProductCategoryMap = createSelector(
  ...
  // 1. find categories and Map them.
  // 2. products find their categories and add them to the product.
  // 3. For missing categories, add baseCategory.
  // 4. Make a page that groups by categoryId (from ProductCore)
