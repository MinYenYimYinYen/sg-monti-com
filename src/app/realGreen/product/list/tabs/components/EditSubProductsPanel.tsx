...
//
// interface EditSubProductsPanelProps {
//   master: ProductMaster;
// }
//
// export function EditSubProductsPanel({ master }: EditSubProductsPanelProps) {
...
//
//   // Reset when the selected master changes
//   React.useEffect(() => {
//     setConfigDocs(master.subProductConfigDocs);
//     setStatus("idle");
//     setSearchTerm("");
//   }, [master.productId, master.subProductConfigDocs]);
//
...
//     <Card>
//       <CardHeader>
//         <CardTitle className={"dev-border"}> Sub-Products</CardTitle>
