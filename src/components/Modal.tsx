  ...
  return createPortal(
    ...
    >
      ...
      <div
        ref={contentRef}
        className={cn(
          "relative z-10 flex flex-col rounded-lg bg-background border border-accent/40 shadow-xl opacity-0 bg-accent/10 backdrop-blur-[10px]",
          className,
        )}
        role="dialog"
        aria-modal="true"
      >
        {/* Header */}
        <div className="flex items-center justify-between border-b border-b-accent/40 px-6 py-4 bg-accent/30 rounded-t-lg flex-shrink-0">
